...
const BletoothMainScreen = () => {
            ...
            <TouchableOpacity
                ...
                <View style={{
                    ...
                    <View style={[styles.row, { alignItems: "flex-start", paddingHorizontal: 10, paddingVertical: 10 }]}>
                        <Text style={{ fontSize: 12, textAlign: 'center', color: '#333333', }}>{"Name: " + "BLE Device " + (index + 1)}</Text>
                                            ...
                                            obj.characteristicList.map((obj2) => {
                                                return (
                                                    <View style={{ marginVertical: 5, borderBottomWidth: 0.5, borderTopWidth: 0.5, paddingVertical: 5 }}>
                                                        <Text style={{ fontSize: 12, color: '#333333', textTransform: "uppercase" }}>
    ...
    // 	setHexValue("")
    // 	let yourStringData = "125" || "helso"

    // 	// var arr = [255, 230, 255];

    // 	// var hexArr = arr.map(n => n.toString(16));
    ...
    // 	// let bytesView = new Uint8Array(yourStringData);
    // 	// console.log(bytesView);
    // 	// let str = new TextDecoder().encoding(bytesView);
    // 	// console.log(str);
    ...
    // 	let temp1 = new Uint8Array(yourStringData);
    ...
    // 	let temp2 = new TextEncoder("uint-8").encode(yourStringData)
    ...
    const writeCharData = (peripheral) => {
        let yourStringData = "0x11"

        // let yourStringData = "0x00"
        // let yourStringData = "0x0000FF"
        // let yourStringData = "0x0000FF"
        const data = stringToBytes(yourStringData);
        console.log("Data0-00--->", data);
        console.log("peripheral--->", peripheral);
...
onColorChange={selectedColor => {
    ...
    let rgbValue = HSVtoRGB(selectedColor.h, selectedColor.s, selectedColor.v);
    console.log("rgbValue-->", rgbValue)

    let temp4 = fromHsv(selectedColor)
    console.log("temp4-->", temp4)

    let temp5 = hsv2rgb(selectedColor.h, selectedColor.s, selectedColor.v)
    console.log("hsv2rgb-->", temp5)
